...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout = dout.reshape(dout.shape[0], W1.shape[0], X.shape[2]//2, X.shape[3]//2)
        dout, dW1, db1 = conv_relu_pool_backward(dout, cache1)
        dW1, dW2, dW3 = dW1 + self.reg * W1, dW2 + self.reg * W2, dW3 + self.reg * W3
        grads['W3'], grads['b3'], grads['W2'], grads['b2'], grads['W1'], grads['b1'] = dW3, db3, dW2, db2, dW1, db1
